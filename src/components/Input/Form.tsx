...
import { Box, Button, FormControl, FormLabel, Heading, Input, InputGroup, InputLeftElement, Select, Textarea } from '@chakra-ui/react'
import InputWrapper from './InputWrapper'

export default function Form() {
  return (
    <>
    <Box data-aos="fade-up" className='py-[52px] shadow-8xl rounded-[10px] px-4 sm:px-8 md:px-12 lg:px-[63px]'>
        <Heading as={'h2'} fontSize={'md'} className='text-[orange] tracking-[0.1px] text-center leading-8 text-2xl md:text-[28px] font-poppin font-bold mb-8 md:mb-[66px]'>Add New Properties</Heading>
        <FormControl isRequired>
            ...
            <Input placeholder={'Enter Amount'} className='form-input'/>
            </InputGroup>
            </InputWrapper>
            <InputWrapper autoclass='sm:col-span-2 md:col-span-3'>
            <FormLabel>Description</FormLabel>
            <Textarea placeholder='Your House Description' className='form-input'/>
            </InputWrapper>
            <Box className='sm:col-span-2 md:col-span-3'>
                <Heading as={'h3'} fontSize={'md'}>Upload Photos</Heading>
        ...
        <Box className='text-center'>
            <Button colorScheme={'orange.300'} type={'submit'} variant='solid' className='bg-[orange] py-5 text-white rounded-[10px] w-[50%] sm:w-[60%] block mt-12 md:mt-[80px]'>Add New Property</Button>
            </Box>
    </Box>
    </>
  )
